...
![Adjusted closing prices of the selected assets over the analysis period, illustrating heterogeneous price dynamics and sector-specific trends across the asset universe.](../notebooks-and-scripts/1-applied-data-science/2-unsupervised-learning-for-asset-allocation/r/1-unsupervised-learning-for-asset-allocation-figures/closing-prices.png){#fig-adjusted-closing-prices}
...
![Covariance matrix of asset returns, showing the magnitude of joint variability across the selected assets used in portfolio risk estimation and allocation.](../notebooks-and-scripts/1-applied-data-science/2-unsupervised-learning-for-asset-allocation/r/1-unsupervised-learning-for-asset-allocation-figures/covariance-matrix.png){#fig-covariance-matrix}
...
![Correlation matrix of asset returns, showing the dependence structure across the selected assets prior to hierarchical clustering reordering.](../notebooks-and-scripts/1-applied-data-science/2-unsupervised-learning-for-asset-allocation/r/1-unsupervised-learning-for-asset-allocation-figures/correlation-matrix.png){#fig-correlation-matrix}
...
![Explained variance ratio for each principal component obtained from PCA, showing that the first components capture most of the variability in the asset return space.](../notebooks-and-scripts/1-applied-data-science/2-unsupervised-learning-for-asset-allocation/r/1-unsupervised-learning-for-asset-allocation-figures/explained-variance-ratio.png){#fig-explained-variance-ratio}

![Cumulative explained variance obtained from Principal Component Analysis (PCA), showing how the first principal components capture most of the variability in the asset return space.](../notebooks-and-scripts/1-applied-data-science/2-unsupervised-learning-for-asset-allocation/r/1-unsupervised-learning-for-asset-allocation-figures/cumulative-explained-variance.png){#fig-cumulative-explained-variance}
...
![Loadings of the first principal component obtained from PCA, illustrating the assets that contribute most strongly to the dominant common risk factor in the portfolio universe.](../notebooks-and-scripts/1-applied-data-science/2-unsupervised-learning-for-asset-allocation/r/1-unsupervised-learning-for-asset-allocation-figures/pc1-loadings.png){#fig-pc1-loadings}

![Loadings of the second principal component obtained from PCA, highlighting contrasting sectoral exposures and latent diversification patterns within the asset universe.](../notebooks-and-scripts/1-applied-data-science/2-unsupervised-learning-for-asset-allocation/r/1-unsupervised-learning-for-asset-allocation-figures/pc2-loadings.png){#fig-pc2-loadings}
...
![Hierarchical clustering dendrogram of the asset universe based on return correlations, revealing sectoral similarity structures used in the Hierarchical Risk Parity (HRP) allocation process.](../notebooks-and-scripts/1-applied-data-science/2-unsupervised-learning-for-asset-allocation/r/1-unsupervised-learning-for-asset-allocation-figures/hierarchical-clustering-dendrogram.png){#fig-hierarchical-clustering-dendrogram}
...
![Clustered correlation matrix of asset returns, highlighting sectoral structure and similarity patterns used in the hierarchical portfolio construction process.](../notebooks-and-scripts/1-applied-data-science/2-unsupervised-learning-for-asset-allocation/r/1-unsupervised-learning-for-asset-allocation-figures/clustered-correlation-matrix.png){#fig-clustered-correlation-matrix}
...
![Equal-weight portfolio allocation assigning identical weights to all assets in the investment universe.](../notebooks-and-scripts/1-applied-data-science/2-unsupervised-learning-for-asset-allocation/r/1-unsupervised-learning-for-asset-allocation-figures/equal-weight-portfolio.png){#fig-equal-weight-portfolio}
...
![Portfolio weights obtained using the Hierarchical Risk Parity (HRP) allocation method, reflecting the hierarchical correlation structure and risk diversification across assets.](../notebooks-and-scripts/1-applied-data-science/2-unsupervised-learning-for-asset-allocation/r/1-unsupervised-learning-for-asset-allocation-figures/hrp-portfolio-weights.png){#fig-hrp-portfolio-weights}
...
![Comparison between equal-weight and Hierarchical Risk Parity (HRP) portfolio allocations, highlighting how the HRP framework redistributes exposure according to the hierarchical correlation and risk structure of the asset universe.](../notebooks-and-scripts/1-applied-data-science/2-unsupervised-learning-for-asset-allocation/r/1-unsupervised-learning-for-asset-allocation-figures/portfolio-weight-comparison.png){#fig-portfolio-weight-comparison}
...
![Risk contribution of each asset under the Hierarchical Risk Parity (HRP) allocation, illustrating how portfolio risk is distributed across the investment universe.](../notebooks-and-scripts/1-applied-data-science/2-unsupervised-learning-for-asset-allocation/r/1-unsupervised-learning-for-asset-allocation-figures/hrp-risk-contribution.png){#fig-hrp-risk-contribution}
...
![Cumulative returns of the compared portfolio strategies over the evaluation period, illustrating differences in long-term growth dynamics and drawdown behavior.](../notebooks-and-scripts/1-applied-data-science/2-unsupervised-learning-for-asset-allocation/r/1-unsupervised-learning-for-asset-allocation-figures/cumulative-portfolio-returns.png){#fig-cumulative-portfolio-returns}

The temporal evolution of portfolio risk is shown in @fig-rolling-annualized-volatility.

![Rolling annualized volatility of the portfolio strategies over time, illustrating the dynamic evolution of portfolio risk under different allocation frameworks.](../notebooks-and-scripts/1-applied-data-science/2-unsupervised-learning-for-asset-allocation/r/1-unsupervised-learning-for-asset-allocation-figures/rolling-annualized-volatility.png){#fig-rolling-annualized-volatility}
...
![Portfolio drawdowns over the evaluation period, comparing the magnitude and persistence of temporary losses across the portfolio strategies.](../notebooks-and-scripts/1-applied-data-science/2-unsupervised-learning-for-asset-allocation/r/1-unsupervised-learning-for-asset-allocation-figures/portfolio-drawdowns.png){#fig-portfolio-drawdowns}
...
Additional implementation details are available in the companion Quarto notebook [here](../notebooks-and-scripts/1-applied-data-science/2-unsupervised-learning-for-asset-allocation/r/1-unsupervised-learning-for-asset-allocation.html). A companion Python implementation is also available [here](../notebooks-and-scripts/1-applied-data-science/2-unsupervised-learning-for-asset-allocation/python/1-unsupervised-learning-for-asset-allocation.html).

:::

::: {.content-visible when-format="pdf"}

Additional implementation details, including the companion Quarto and Python notebooks, are available in the project repository \href{https://github.com/rodrigokang/portfolio/tree/main/notebooks-and-scripts/1-applied-data-science/2-unsupervised-learning-for-asset-allocation}{\faGithub}
