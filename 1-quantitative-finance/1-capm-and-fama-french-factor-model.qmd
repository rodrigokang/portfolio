...
Additional implementation details are available in the companion Quarto notebook [here](../notebooks-and-scripts/1-quantitative-finance/1-capm-and-fama-french-factor-model/r/1-capm-model.html). A companion Python implementation is also available [here](../notebooks-and-scripts/1-quantitative-finance/1-capm-and-fama-french-factor-model/python/1-capm-model.html).

:::

::: {.content-visible when-format="pdf"}

Additional implementation details, including the companion Quarto and Python notebooks, are available in the project repository \href{https://github.com/rodrigokang/portfolio/tree/main/notebooks-and-scripts/1-quantitative-finance/1-capm-and-fama-french-factor-model}{\faGithub}
...
Additional implementation details are available in the companion Quarto notebook [here](../notebooks-and-scripts/1-quantitative-finance/1-capm-and-fama-french-factor-model/r/2-fama-french-three-factor-model.html). A companion Python implementation is also available [here](../notebooks-and-scripts/1-quantitative-finance/1-capm-and-fama-french-factor-model/python/2-fama-french-three-factor-model.html).
