...
The asset universe used in the study is summarized in Table @tbl-asset-universe.
...
The explained variance associated with each principal component is summarized in Table @tbl-pca-explained-variance.
...
A direct comparison between the equal-weight benchmark and the HRP allocation is shown in @fig-portfolio-weight-comparison and Table @tbl-portfolio-weight-comparison.
...
The final performance summary is presented in Table @tbl-portfolio-performance.
...
This appendix provides supplementary mathematical and methodological details related to the unsupervised learning techniques used throughout the project.
