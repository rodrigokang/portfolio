...
![Adjusted closing prices for Apple Inc. and the S\&P 500 index between 2020 and 2024. The figure is mainly used as a preliminary inspection of the downloaded financial time series before return calculation.](../notebooks-and-scripts/1-applied-data-science/1-capm-and-fama-french-factor-model/r/1-capm-model-figures/closing-prices.png){#fig-capm-closing-prices}
...
![CAPM linear regression between Apple daily returns and S\&P 500 daily returns. The red line represents the fitted linear relationship estimated through ordinary least squares regression.](../notebooks-and-scripts/1-applied-data-science/1-capm-and-fama-french-factor-model/r/1-capm-model-figures/capm-regression.png){#fig-capm-regression}

::: {.content-visible when-format="html"}

Additional implementation details are available in the companion Quarto notebook [here](../notebooks-and-scripts/1-applied-data-science/1-capm-and-fama-french-factor-model/r/1-capm-model.html). A companion Python implementation is also available [here](../notebooks-and-scripts/1-applied-data-science/1-capm-and-fama-french-factor-model/python/1-capm-model.html).

:::

::: {.content-visible when-format="pdf"}

Additional implementation details, including the companion Quarto and Python notebooks, are available in the project repository \href{https://github.com/rodrigokang/portfolio/tree/main/notebooks-and-scripts/1-applied-data-science/1-capm-and-fama-french-factor-model}{\faGithub}
...
Additional implementation details are available in the companion Quarto notebook [here](../notebooks-and-scripts/1-applied-data-science/1-capm-and-fama-french-factor-model/r/2-fama-french-three-factor-model.html). A companion Python implementation is also available [here](../notebooks-and-scripts/1-applied-data-science/1-capm-and-fama-french-factor-model/python/2-fama-french-three-factor-model.html).
...
![Fama–French daily factor series.](../notebooks-and-scripts/1-applied-data-science/1-capm-and-fama-french-factor-model/r/2-fama-french-three-factor-model-figures/fama_french_factor_series.png){#fig-fama-french-factor-series}
...
![Observed and fitted excess returns under the Fama–French three-factor specification.](../notebooks-and-scripts/1-applied-data-science/1-capm-and-fama-french-factor-model/r/2-fama-french-three-factor-model-figures/fama_french_observed_vs_fitted_returns.png){#fig-fama-french-observed-fitted}
...
![Residual series of the Fama–French three-factor model.](../notebooks-and-scripts/1-applied-data-science/1-capm-and-fama-french-factor-model/r/2-fama-french-three-factor-model-figures/fama_french_residuals.png){#fig-fama-french-residuals}
...
![Distribution of residuals from the Fama–French three-factor model.](../notebooks-and-scripts/1-applied-data-science/1-capm-and-fama-french-factor-model/r/2-fama-french-three-factor-model-figures/fama_french_residual_distribution.png){#fig-fama-french-residual-distribution}
...
For readers interested in a more detailed mathematical treatment, including derivations and additional discussion, the accompanying technical note is available <a href="../personal-notes/computer-science/linear-regression/notes.pdf" download><i class="bi bi-file-earmark-pdf"></i></a>.

:::

::: {.content-visible when-format="pdf"}

For readers interested in a more detailed mathematical treatment, including derivations and additional discussion, the accompanying technical note is available \href{https://raw.githubusercontent.com/rodrigokang/portfolio/main/personal-notes/computer-science/linear-regression/notes.pdf}{\faFilePdf}.
