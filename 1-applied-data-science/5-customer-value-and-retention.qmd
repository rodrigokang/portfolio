...
A complete Python implementation of the RFM analysis presented in this section is available in the companion notebook [here](../notebooks-and-scripts/1-applied-data-science/5-customer-value-and-retention/python/1-rfm-analysis.html).

:::

::: {.content-visible when-format="pdf"}

A complete Python implementation of the RFM analysis presented in this section is available in the project repository \href{https://github.com/rodrigokang/portfolio/tree/main/notebooks-and-scripts/1-applied-data-science/5-customer-value-and-retention}{\faGithub}.
...
A complete Python implementation of the churn prediction model presented in this section is available in the companion notebook [here](../notebooks-and-scripts/1-applied-data-science/5-customer-value-and-retention/python/2-churn-prediction.html).

:::

::: {.content-visible when-format="pdf"}

A complete Python implementation of the churn prediction model presented in this section is available in the project repository \href{https://github.com/rodrigokang/portfolio/tree/main/notebooks-and-scripts/1-applied-data-science/5-customer-value-and-retention}{\faGithub}.
...
A complete Python implementation of the customer lifetime value model presented in this section is available in the companion notebook [here](../notebooks-and-scripts/1-applied-data-science/5-customer-value-and-retention/python/3-clv-prediction.html).

An interactive Streamlit application implementing the methods presented in this chapter is available [here](https://github.com/rodrigokang/portfolio/tree/main/notebooks-and-scripts/1-applied-data-science/5-customer-value-and-retention/dashboard).

:::

::: {.content-visible when-format="pdf"}

A complete Python implementation of the customer lifetime value model presented in this section is available in the project repository \href{https://github.com/rodrigokang/portfolio/tree/main/notebooks-and-scripts/1-applied-data-science/5-customer-value-and-retention}{\faGithub}.

An interactive Streamlit application implementing the methods presented in this chapter is available \href{https://github.com/rodrigokang/portfolio/tree/main/notebooks-and-scripts/1-applied-data-science/5-customer-value-and-retention/dashboard}{\faGithub}.
...
![Distribution of the original RFM variables before transformation.](../notebooks-and-scripts/1-applied-data-science/5-customer-value-and-retention/python/1-customer-value-and-retention-rfm-figures/rfm-feature-distributions.png){#fig-rfm-distributions}
...
![Cluster selection diagnostics for different values of (k).](../notebooks-and-scripts/1-applied-data-science/5-customer-value-and-retention/python/1-customer-value-and-retention-rfm-figures/cluster-selection-metrics.png){#fig-cluster-selection}
...
![Three-dimensional representation of the customer segments in the original RFM space.](../notebooks-and-scripts/1-applied-data-science/5-customer-value-and-retention/python/1-customer-value-and-retention-rfm-figures/customer-segments-rfm-space.png){#fig-rfm-space}
...
: Performance comparison of the evaluated churn prediction models. Abbreviations: RF = Random Forest; XGB = XGBoost; LR = Logistic Regression; AP = Average Precision; BA = Balanced Accuracy. {#tbl-churn-model-comparison}
...
![Receiver Operating Characteristic curve for the selected churn prediction model.](../notebooks-and-scripts/1-applied-data-science/5-customer-value-and-retention/python/2-customer-value-and-retention-churn-figures/roc-curve.png){#fig-roc}

![Precision–Recall curve for the selected churn prediction model.](../notebooks-and-scripts/1-applied-data-science/5-customer-value-and-retention/python/2-customer-value-and-retention-churn-figures/precision-recall-curve.png){#fig-pr-curve}
...
![Confusion matrix for the selected churn prediction model.](../notebooks-and-scripts/1-applied-data-science/5-customer-value-and-retention/python/2-customer-value-and-retention-churn-figures/confusion-matrix.png){#fig-confusion-matrix}
...
![Cumulative gains curve for the selected churn prediction model.](../notebooks-and-scripts/1-applied-data-science/5-customer-value-and-retention/python/2-customer-value-and-retention-churn-figures/cumulative-gains-curve.png){#fig-cumulative-gains}
...
![Feature importance for the selected churn prediction model.](../notebooks-and-scripts/1-applied-data-science/5-customer-value-and-retention/python/2-customer-value-and-retention-churn-figures/top-feature-importances.png){#fig-feature-importance}
...
![Predicted versus observed Customer Lifetime Value on the independent test set.](../notebooks-and-scripts/1-applied-data-science/5-customer-value-and-retention/python/3-customer-value-and-retention-clv-figures/predicted-vs-actual-clv.png){#fig-predicted-vs-actual}

![Residual analysis for the selected Customer Lifetime Value model.](../notebooks-and-scripts/1-applied-data-science/5-customer-value-and-retention/python/3-customer-value-and-retention-clv-figures/residual-plot.png){#fig-residuals}
...
![Feature importance for the selected Customer Lifetime Value model.](../notebooks-and-scripts/1-applied-data-science/5-customer-value-and-retention/python/3-customer-value-and-retention-clv-figures/feature-importance.png){#fig-clv-feature-importance}
...
![Distribution of predicted Customer Lifetime Value across customer segments.](../notebooks-and-scripts/1-applied-data-science/5-customer-value-and-retention/python/3-customer-value-and-retention-clv-figures/predicted-clv-by-segment.png){#fig-clv-by-segment}

![Total predicted Customer Lifetime Value aggregated by customer segment.](../notebooks-and-scripts/1-applied-data-science/5-customer-value-and-retention/python/3-customer-value-and-retention-clv-figures/total-predicted-clv-by-segment.png){#fig-total-clv-by-segment}
