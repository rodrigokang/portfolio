...
A complete Python implementation of the workflow presented in this chapter is available in the companion notebook [here](../notebooks-and-scripts/1-applied-data-science/6-customer-feedback-nlp/python/1-understanding-customer-feedback-nlp.html).

:::

::: {.content-visible when-format="pdf"}

A complete Python implementation of the workflow presented in this chapter is available in the project repository \href{https://github.com/rodrigokang/portfolio/tree/main/notebooks-and-scripts/1-applied-data-science/6-customer-feedback-nlp}{\faGithub}.

:::

::: {.content-visible when-format="html"}

An Azure-compatible deployment implementing the inference service presented in this chapter is available in the project repository [here](https://github.com/rodrigokang/portfolio/tree/main/notebooks-and-scripts/1-applied-data-science/6-customer-feedback-nlp).

:::

::: {.content-visible when-format="pdf"}

An Azure-compatible deployment implementing the inference service presented in this chapter is available in the project repository \href{https://github.com/rodrigokang/portfolio/tree/main/notebooks-and-scripts/1-applied-data-science/6-customer-feedback-nlp}{\faGithub}.
