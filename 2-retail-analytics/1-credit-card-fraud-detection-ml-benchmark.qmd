...
The supervised benchmarking stage is complete and covers model training, cross-validation, class imbalance treatments, and comparative performance evaluation across all selected algorithms.

The detailed discussion of the supervised results is currently being prepared for this chapter. In the meantime, the complete analysis, figures, and implementation details are available in the companion materials:

* R / Quarto notebook: [link]
* Python notebook: [link]
* Project repository: [link]

These materials contain the complete experimental workflow and reproducible implementation associated with this stage of the project.
