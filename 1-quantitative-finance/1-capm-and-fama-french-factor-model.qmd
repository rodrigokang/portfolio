...
::: {#tbl-capm-coefficients}

Table: Estimated CAPM regression coefficients for Apple Inc. using the S&P 500 as the market proxy.
...
::: {#tbl-capm-diagnostics}

Table: Diagnostic statistics associated with the CAPM linear regression model.
...
::: {#tbl-ff3-coefficients}

Table: Estimated Fama–French three-factor regression coefficients for Apple Inc.
...
Table: Diagnostic statistics associated with the Fama–French three-factor regression model.
